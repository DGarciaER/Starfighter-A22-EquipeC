...
if __name__ == "__main__":
    ...
    collision.verfierToutesCollisions(vaisseau,spawns.listeOvnis, shoot.listeMissiles ,spawns.listAsteroides, spawns.listPU ,playerControl)    #TODO ajouter collision avec powerup
